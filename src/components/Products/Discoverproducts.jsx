...
<div className="text-center font-bold text-3xl my-8 relative">
  <p className=" sm:inline-block relative group">
    ...
    <span className="text-3xl text-gray-900">Shop by category</span>
  </p>
  <span style={lineStyle}></span>
  <div className="sm:hidden">
    <select
      className="block  w-full border text-gray-800 border-gray-300 p-2 rounded-md"
...
<div className="hidden sm:block flex justify-end sm:mr-20 mb-6 relative">
  ...
  >
    ...
    Filters
      ...
      <h3 className="text-md text-gray-800 font-semibold mb-1">Categories</h3>
        <ul>
          <li className="cursor-pointer py-1 px-2  text-gray-700" onClick={() => handleCategoryChange("FD")}>
       ...
       <div  style={{ marginLeft: '-10px' }}>
    <h3 className="text-md font-semibold mb-1 mt-2 text-gray-800">Price (Birr)</h3>
    <ul>
      <li className="cursor-pointer py-1 px-2  text-gray-700" onClick={() => handlePriceFilterChange(  {price__lt: 300} )}>
